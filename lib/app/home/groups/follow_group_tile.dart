...
class FollowGroupTile extends StatefulWidget {
  ...
  const FollowGroupTile({required this.group, required this.groupsFollowing});

  @override
  State<FollowGroupTile> createState() => _FollowGroupTileState();
}

class _FollowGroupTileState extends State<FollowGroupTile> with AutomaticKeepAliveClientMixin{
  ...
  void initState() {
    super.initState();
    isFollowing = widget.groupsFollowing.contains(widget.group.name) ? true : false;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () async {
        ...
        isFollowing! ? database.followGroup(database.uid, widget.group.name) : database.unfollowGroup(database.uid, widget.group.name);
      },
      child: Container(
