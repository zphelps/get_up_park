...
import 'package:get_up_park/app/sign_in/sign_in_button.dart';
import 'package:get_up_park/app/sign_in/sign_in_view.dart';
import 'package:get_up_park/app/sign_in/sign_in_view_modal.dart';
...
class SignInPageContents extends StatelessWidget {
  const SignInPageContents(
      {Key? key, required this.viewModel, this.title = 'Get Up Park'})
      : super(key: key);
