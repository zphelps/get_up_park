...
class HouseCupEventTile extends StatelessWidget {
  const HouseCupEventTile({required this.event, required this.user});
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    DateFormat.MMMEd().format(DateTime.parse(event.date)),
                    style: TextStyle(
