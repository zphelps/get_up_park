...
class CreateGroupEventView extends StatefulWidget {
  const CreateGroupEventView({required this.group});

  final Group group;

  @override
  State<CreateGroupEventView> createState() => _CreateGroupEventViewState();
}

class _CreateGroupEventViewState extends State<CreateGroupEventView> {
  ...
  void initState() {
    ...
    _groupLogoURL = widget.group.logoURL;
  }
