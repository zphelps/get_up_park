...
class EditArticleView extends StatefulWidget {
  const EditArticleView({required this.article});
...
class _EditArticleViewState extends State<EditArticleView> {
  ...
  Future<void> _submit(bool fileImage) async {
    try {
      setState(() {
        _loading = true;
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          _formComplete ? 'Review article' : 'Edit article',
      ...
      body: _formComplete ? article_preview_widget(context, Article(
        ...
        title: _title!,
        body: _body!,
        imageURL: _image == null ? widget.article.imageURL : _image!.path,
        category: _category!,
        group: _group!,
        groupLogoURL: _groupLogoURL!,
        date: DateTime.now().toString(),
  ...
  Widget article_preview_widget(BuildContext context, Article article, bool fileImage) {
    return Stack(
      children: [
        CustomScrollView(
          slivers: <Widget>[
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: DecoratedBox(
                  ...
                  child: !fileImage ? CachedNetworkImage(
                    memCacheHeight: 4000,
                    memCacheWidth: 4000,
                    imageUrl: widget.article.imageURL,
                    fit: BoxFit.cover,
